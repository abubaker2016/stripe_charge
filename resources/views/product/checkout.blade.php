                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="text-left"><b>{{ $productData->price }}</b></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="row">
                                ...
                                <form id="paymentForm" method="POST" action="{{ route('purchase') }}" class="card-form mt-3 mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mt-3 text-center">
                                            ...
                                            <input type="hidden" name="productInfo" value="{{ $productData->id }}" />
                                            <a id="card-button" class="btn btn-primary pay">Pay Now</a>
                                        </div>
                                    </div>                                    
                                </form>
                            </div>
...
@section('bottom-script')
    ...
    <script>
       ...
       // const stripe = Stripe("pk_test_51PvD1vRqu43lX7NQ2fOOxZNKC9threq1oRHM8oxMiIPOKX85nrftB0xL0ZTnLBOGsAYTb6gmtzg6GVvkDPeyAejQ00tSkI3ioQ");
